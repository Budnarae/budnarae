...
Hello, my name is Sinhwa Hong, and I am an aspiring Graphics/Engine Programmer. I am currently enrolled in the Krafton GameTechLab program and will be graduating soon.

To build the necessary skills for my career goals, I participated in both the Krafton GameTechLab and 42 Seoul programs.

At GameTechLab, I focused on game engine architecture and rendering systems. Over the course of 14 weeks, I collaborated with teammates to design and implement a custom game engine based on DirectX 11. Afterward, I developed a plugin for Unreal Engine 5 and successfully published it on the FAB Marketplace.

At 42 Seoul, I completed several system programming projects using the POSIX API. By implementing a Ray Tracer, Unix Shell, and IRC Server in C/C++, I strengthened my foundation in low-level programming.
